...
# ===== 设置自定义参数 =====
echo "===== 欧加真MT6993通用6.12.23 A16 OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
echo "正在克隆源码仓库..."
aria2c -s16 -x16 -k1M https://github.com/SunsetRNE/android_kernel_oppo_mt6993/archive/refs/heads/oppo/mt6993_b_16.0.0_find_x9.zip -o common.zip && 
unzip -q common.zip && 
