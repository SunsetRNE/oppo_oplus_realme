...
# ===== 设置自定义参数 =====
echo "===== 欧加真SM8850通用6.12.58 A16 OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
echo "正在克隆源码仓库..."
aria2c -s16 -x16 -k1M https://github.com/SunsetRNE/android_kernel_common_oneplus_sm8850/archive/refs/heads/oneplus/sm8850_b_16.0_pad_3_pro.zip -o common.zip && 
unzip -q common.zip && 
