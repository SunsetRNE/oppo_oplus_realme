...
# ===== 设置自定义参数 =====
echo "===== 新版米系/欧加真通用 6.12.23 GKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
echo "正在克隆源码仓库..."
aria2c -s16 -x16 -k1M https://github.com/SunsetRNE/android_gki_kernel_common/archive/refs/heads/android16-6.12-2025-06.zip -o common.zip &&
unzip -q common.zip &&
