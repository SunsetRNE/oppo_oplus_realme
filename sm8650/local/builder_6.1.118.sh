...
# ===== 设置自定义参数 =====
echo "===== 欧加真SM8650通用6.1.118 A15 OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
cd kernel_workspace
git clone --depth=1 https://github.com/SunsetRNE/android_kernel_common_oneplus_sm8650 -b oneplus/sm8650_b_16.0.0_oneplus12 common
echo ">>> 初始化仓库完成"
