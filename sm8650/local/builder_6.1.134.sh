...
# ===== 设置自定义参数 =====
echo "===== 欧加真MT6989通用6.1.134 A16 (天玑特供)OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
cd kernel_workspace
git clone --depth=1 https://github.com/SunsetRNE/android_kernel_oneplus_mt6989 -b oneplus/mt6989_b_16.0.0_ace5_race common
echo ">>> 初始化仓库完成"
