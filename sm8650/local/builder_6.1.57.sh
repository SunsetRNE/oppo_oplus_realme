...
# ===== 设置自定义参数 =====
echo "===== 欧加真SM8650通用6.1.57 A14 OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
cd kernel_workspace
git clone --depth=1 https://github.com/SunsetRNE/android_kernel_common_oneplus_sm8650 -b oneplus/sm8650_u_14.0.0_oneplus12 common
echo ">>> 初始化仓库完成"
...
if [[ $KSU_BRANCH == [yYrR] ]]; then
  ...
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/other_patch/apk_sign.patch
...
if [[ "$APPLY_SUSFS" == [yY] ]]; then
  echo ">>> 克隆补丁仓库..."
  git clone --depth=1 https://github.com/SunsetRNE/susfs4oki.git susfs4ksu -b oki-android14-6.1
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/other_patch/69_hide_stuff.patch -O ./common/69_hide_stuff.patch
...
if [[ "$APPLY_LZ4" == "y" || "$APPLY_LZ4" == "Y" ]]; then
  ...
  git clone --depth=1 https://github.com/SunsetRNE/oppo_oplus_realme_sm8650.git
...
cd common
wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/other_patch/cve-2026-43499-rtmutex-6.1.patch
...
if [[ "$APPLY_BETTERNET" == "y" || "$APPLY_BETTERNET" == "Y" ]]; then
  ...
  cd common
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/other_patch/config.patch
...
if [[ "$APPLY_DROIDSPACES" == [sSeE] ]]; then
  ...
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/droidspaces_patch/fix_sysvipc_kabi_6_7_8.patch
  patch -p1 -F 3 < fix_sysvipc_kabi_6_7_8.patch || true
  # 修补 oplus_bsp_midas 行为，避免开机崩溃
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/droidspaces_patch/fix_oplus_bsp_midas.patch
  patch -p1 -F 3 < fix_oplus_bsp_midas.patch || true
  # 应用 NTSync 补丁
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/droidspaces_patch/ntsync_base.patch
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/droidspaces_patch/ntsync_compat_android14-6.1.patch
  ...
  if [[ "$APPLY_DROIDSPACES" == [eE] ]]; then
    ...
    cd common
    wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8650/raw/refs/heads/main/droidspaces_patch/evdi_drm.patch
...
if [[ "$APPLY_LZ4KD" == "y" || "$APPLY_LZ4KD" == "Y" ]]; then
  wget https://raw.githubusercontent.com/SunsetRNE/oppo_oplus_realme_sm8650/refs/heads/main/other_patch/zram.zip
fi
