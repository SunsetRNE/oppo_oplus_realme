...
# ===== 设置自定义参数 =====
echo "===== 欧加真SM8750通用6.6.56 A15 OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
cd kernel_workspace
git clone --depth=1 https://github.com/SunsetRNE/android_kernel_common_oneplus_sm8750 -b oneplus/sm8750_v_15.0.2_oneplus_13t common
echo ">>> 初始化仓库完成"
