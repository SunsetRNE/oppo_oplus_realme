...
# ===== 设置自定义参数 =====
echo "===== 欧加真SM8750通用6.6.118 A15 OKI内核本地编译脚本 By Coolapk@SunsetRNE ====="
echo ">>> 读取用户配置..."
...
cd kernel_workspace
git clone --depth=1 https://github.com/SunsetRNE/android_kernel_common_oneplus_sm8750 -b oneplus/sm8750_v_16.0.0_oneplus_13_6.6.118 common
echo ">>> 初始化仓库完成"
...
if [[ "$APPLY_SUSFS" == [yY] ]]; then
  echo ">>> 克隆补丁仓库..."
  git clone --depth=1 https://github.com/SunsetRNE/susfs4oki.git susfs4ksu -b oki-android15-6.6
...
if [[ "$APPLY_LZ4" == "y" || "$APPLY_LZ4" == "Y" ]]; then
  ...
  git clone --depth=1 https://github.com/SunsetRNE/oppo_oplus_realme_sm8750.git
...
cd common
wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/other_patch/cve-2026-43499-rtmutex-6.6.patch
...
if [[ "$APPLY_BETTERNET" == "y" || "$APPLY_BETTERNET" == "Y" ]]; then
  ...
  cd common
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/other_patch/config.patch
...
if [[ "$APPLY_DROIDSPACES" == [sSeE] ]]; then
  ...
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/fix_sysvipc_kabi_6_7_8.patch
  patch -p1 -F 3 < fix_sysvipc_kabi_6_7_8.patch || true
  # 修补 oplus_bsp_midas 行为，避免开机崩溃
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/fix_oplus_bsp_midas.patch
  patch -p1 -F 3 < fix_oplus_bsp_midas.patch || true
  # 应用 NTSync 补丁
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/ntsync_base.patch
  wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/ntsync_compat_android15-6.6.patch
  ...
  if [[ "$APPLY_DROIDSPACES" == [eE] ]]; then
    ...
    cd common
    wget https://github.com/SunsetRNE/oppo_oplus_realme_sm8750/raw/refs/heads/main/droidspaces_patch/evdi_drm.patch
...
if [[ "$APPLY_LZ4KD" == "y" || "$APPLY_LZ4KD" == "Y" ]]; then
  wget https://raw.githubusercontent.com/SunsetRNE/oppo_oplus_realme_sm8750/refs/heads/main/zram.zip
fi
